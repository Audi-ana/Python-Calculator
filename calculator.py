...
def equal():
    second_number = e.get() #this is gonna pull whatever is in the text box
    e.delete(0, END)
...
#Define Buttons - because you can't pass a parameter in a button you have to use lambda 
...
button_0 = Button(window, text="0", padx=39, pady=20, command=lambda: button_click(0))
...
button_clear = Button(window, text="CE", padx=38, pady=20, command=clear)


#Positioning the buttons the way you want them to be displayed
